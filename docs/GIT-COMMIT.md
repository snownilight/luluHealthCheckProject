...
- **Ticket-ID**: Jira 等專案管理工具的工單號碼，請用中括號包起來，例如 `[PET-101]`。
...
```text
feat(kafka): [PET-101] 實作寵物餵食事件 Kafka Consumer
...
**⭐ 範例 2：修復 Bug**
```text
fix(redis): [PET-205] 修正飲水計時器過期通知未觸發問題
...
**⭐ 範例 3：未分 scope 的小修改**
```text
chore: [PET-302] 升級 Flutter 依賴套件版本
```
